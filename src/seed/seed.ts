...
export const PAGES: PageSeed[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'p', text: 'Ready-to-ship pieces can be returned within 14 days of delivery for a full refund of the item price (excluding original shipping). They must be unused and in their original condition and packaging. To start a return, email orders@suaviusatelier.com with your order number. Return shipping is at your expense unless the item arrived faulty.' },
      { type: 'h2', text: 'Made-to-order and personalized items' },
      { type: 'p', text: 'Because made-to-order and personalized pieces are crafted specifically for you, under EU consumer law they are exempt from the 14-day right of withdrawal and cannot be returned or refunded if you simply change your mind. Please double-check your specifications (engraving text, options, sizing) before ordering, and email us first if you are unsure. We are glad to help.' },
      { type: 'p', text: 'This does not affect your statutory rights. If a personalized item arrives damaged, defective, or not as described, you are fully covered: contact us within 30 days of delivery and we will repair, replace, or refund it. Where only part of an order is affected, we will refund or remake that part.' },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'p', text: 'This right does not apply to goods made to your specifications or clearly personalised (for example, custom engraving or made-to-order pieces), in accordance with Article 16(c) of Directive 2011/83/EU and Article 38(3) of the Polish Act on Consumer Rights. Such items cannot be returned for a refund if you change your mind; they remain fully covered by your statutory warranty rights below if they are faulty, damaged, or not as described.' },
